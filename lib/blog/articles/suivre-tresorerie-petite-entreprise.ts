...
export const article: BlogArticle = {
  ...
  "description": "Un suivi simple permet de voir les entrées, les sorties, les factures attendues et les échéances.",
  ...
  "sections": [
    {
      "heading": "Ce que le solde bancaire ne vous dit pas",
      "paragraphs": [
    ...
    {
      "heading": "Deux types de visibilité à créer",
      "paragraphs": [
    ...
    {
      "heading": "Les pièges du suivi trop lourd",
      "list": [
    ...
    {
      "heading": "La routine simple qui fonctionne",
      "steps": [
