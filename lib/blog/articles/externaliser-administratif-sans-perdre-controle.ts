...
export const article: BlogArticle = {
  ...
  "description": "Un cadre clair, des accès maîtrisés et des comptes rendus réguliers permettent de déléguer sans inquiétude.",
  "category": "Délégation",
  ...
  "sections": [
    {
      "heading": "Le mythe du contrôle impossible",
      "paragraphs": [
    ...
    {
      "heading": "L'outil majeur : la transparence documentée",
      "paragraphs": [
    ...
    {
      "heading": "Un exemple : vérifier sans surveiller",
      "paragraphs": [
    ...
    {
      "heading": "Les trois garde-fous essentiels",
      "list": [
    ...
    {
      "heading": "L'engagement de durée : pourquoi c'est important",
      "paragraphs": [
  ...
  "faq": [
    {
      "question": "Combien de temps dois-je consacrer à vérifier l'administratif externalisé ?",
      "answer": "Environ 10 % du temps que la tâche prenait avant. Si ça prenait 10 heures, vous en mettez 1 à vérifier. C'est un investissement pour vous assurer que ça tourne bien, pas du contrôle permanent."
    },
    {
      "question": "Que fais-je si je détecte une erreur ou un oubli ?",
      "answer": "Signalez-la calmement, corrigez ensemble, documentez pour que ça ne se reproduise pas. Ce n'est pas une raison de faire marche arrière — c'est le processus normal d'ajustement. Chaque correction améliore le système."
    },
    {
      "question": "Comment gérer les situations où il y a des impayés à relancer ?",
      "answer": "C'est une tâche qui se délègue bien. Définissez avec votre assistant : qui relancer, à quel intervalle, avec quel message. Il envoie les relances, il vous envoie la liste des impayés non réglés malgré les relances. Vous décidez ce qu'il faut faire (appel, changement de conditions, etc.). Division claire : elle exécute le processus, vous prenez les décisions."
    }
  ]
};
