...
export const article: BlogArticle = {
  ...
  "description": "Le prix dépend du volume, de la complexité, de l'urgence, du niveau de responsabilité et du besoin de pilotage.",
  "category": "Délégation",
  ...
  "sections": [
    {
      "heading": "Le premier facteur : le volume réel de travail",
      "paragraphs": [
    ...
    {
      "heading": "Les couches de complexité qui modulent le prix",
      "list": [
    ...
    {
      "heading": "Cinq autres facteurs qui influent sur le chiffrage",
      "paragraphs": [
    ...
    {
      "heading": "Négocier le devis juste",
      "paragraphs": [
