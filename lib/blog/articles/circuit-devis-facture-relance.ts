...
export const article: BlogArticle = {
  ...
  "description": "Un circuit clair de devis, facturation et relance améliore la trésorerie et réduit la charge mentale.",
  ...
  "sections": [
    {
      "heading": "Pourquoi ce circuit est vraiment la base de tout",
      "paragraphs": [
    ...
    {
      "heading": "Les trois étapes essentielles à clarifier",
      "paragraphs": [
    ...
    {
      "heading": "Les pièges courants et comment les éviter",
      "paragraphs": [
