...
export const article: BlogArticle = {
  ...
  "description": "Le gain dépend du volume de tâches répétitives et de la qualité du système de départ.",
  ...
  "sections": [
    ...
    {
      "heading": "Les gains réels dans trois scénarios",
      "paragraphs": [
    ...
    {
      "heading": "Les pièges qui ruinent l'automatisation",
      "paragraphs": [
    ...
    {
      "heading": "La checklist du projet d'automatisation gagnant",
      "steps": [
        "Choisir UNE tâche qui revient régulièrement (au moins deux fois par semaine) et qui ne change jamais vraiment",
        "Mesurer précisément le temps réellement consacré à cette tâche pendant deux semaines",
        "Évaluer le temps de configuration (un jour ? deux jours ?) et le temps de pilotage mensuel (30 minutes ?)",
        "Calculer le payback simple : (Temps gagné par semaine - Temps de pilotage) × 4,3 semaines ÷ Temps de configuration",
        "Si vous gagnez une semaine d'avance au bout d'un mois, lancez. Sinon, choisissez une autre tâche",
        "Après un mois en production, comparer le gain théorique au gain réel et ajuster"
      ]
    }
  ],
  "faq": [
    {
      "question": "Quel est le temps minimal de configuration pour que ça vaille la peine ?",
      "answer": "Généralement, deux jours de travail (4-8 heures) pour une tâche bien définie. Si la configuration prend deux semaines, c'est que la tâche est trop complexe ou trop mal définie. Cherchez quelque chose de plus simple."
    },
    {
      "question": "Et si après un mois, le système a besoin d'ajustements ?",
      "answer": "C'est normal. Prévoyez une heure par mois pour revoir le système et le corriger si besoin. C'est de la maintenance habituelle, comme une voiture. Si la maintenance coûte plus de temps que le gain, l'automatisation n'était pas bonne."
    }
  ]
};
