...
export const article: BlogArticle = {
  ...
  "description": "Un créneau fixe évite que l'administratif s'invite partout et tout le temps.",
  ...
  "sections": [
    {
      "heading": "L'urgence perçue qui paralyse",
      "paragraphs": [
    ...
    {
      "heading": "Deux impacts concrets et mesurables",
      "steps": [
  ...
  "faq": [
    {
      "question": "Quel jour choisir, et qu'en faire des urgences vraies qui arrivent entre deux créneaux ?",
      "answer": "Les vrais urgences (une pièce qui doit partir aujourd'hui) se traitent tout de suite. Mais vous découvrirez que 80 % des « urgences » peuvent attendre 2-3 jours. Si c'est vraiment urgent chaque semaine, votre créneau est probablement trop court."
    },
    {
      "question": "Je dois impérativement me concentrer sur les clients, je n'ai vraiment pas 2-3 heures.",
      "answer": "Demandez-vous : combien de temps passez-vous en ce moment à gérer l'administratif de façon diffuse et inefficace chaque semaine ? Souvent c'est 4-5 heures, juste réparties dans la semaine. Le créneau concentre et accélère, donc vous en faites plus en moins de temps grâce à la continuité."
    }
  ]
};
