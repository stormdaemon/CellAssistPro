...
export const article: BlogArticle = {
  ...
  "description": "La première délégation doit être concrète, utile et facile à vérifier pour installer la confiance.",
  "category": "Délégation",
  ...
  "sections": [
    {
      "heading": "Commencer par du visible et du mesurable",
      "paragraphs": [
    ...
    {
      "heading": "Ce qu'il faut éviter pour la première mission",
      "paragraphs": [
    ...
    {
      "heading": "Le cas du dirigeant qui teste avant de s'engager",
      "paragraphs": [
    ...
    {
      "heading": "Cadrer la première mission pour qu'elle réussisse",
      "steps": [
  ...
  "faq": [
    {
      "question": "Dois-je encadrer très strictement dès le début ?",
      "answer": "Oui au départ : exemples, modèles, critères de réussite. Ce n'est pas pour contrôler, c'est pour qu'il n'y ait aucun malentendu. Après une semaine, si tout va bien, vous pouvez relâcher progressivement."
    },
    {
