...
export const article: BlogArticle = {
  ...
  "description": "Des relances régulières et bien cadrées améliorent la trésorerie sans abîmer la relation client.",
  ...
  "sections": [
    ...
    {
      "heading": "Structurer un circuit de relance qui marche",
      "paragraphs": [
    ...
    {
      "heading": "Éviter les pièges du système trop rigide",
      "paragraphs": [
  ...
  "faq": [
    {
      "question": "Quel délai choisir pour la première relance ?",
      "answer": "Cela dépend de votre secteur et de vos clients. Pour une prestation en B2B, 15 jours après émission laisse du temps. Pour du BtoC ou des chantiers rapides, 10 jours peuvent suffire. Observez vos délais actuels et testez. Vous pouvez ajuster après quelques mois."
    },
    {
      "question": "Comment gérer un client qui demande un délai ?",
      "answer": "Accepter est souvent plus profitable qu'insister. Notez le nouveau délai dans votre tableau, suspendez les rappels automatiques et reconfirmez le virement convenu. Un client respectueux d'un délai négocié paiera souvent plus régulièrement après."
    }
  ]
};
