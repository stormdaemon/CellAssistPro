...
export const article: BlogArticle = {
  ...
  "description": "Il est temps de déléguer quand l'administratif ralentit votre cœur de métier, vos clients ou votre vie personnelle.",
  "category": "Délégation",
  ...
  "sections": [
    {
      "heading": "La limite personnelle plutôt que le chiffre d'affaires",
      "paragraphs": [
    ...
    {
      "heading": "Trois signaux que ça devient trop",
      "paragraphs": [
    ...
    {
      "heading": "Le piège : attendre une catastrophe",
      "list": [
  ...
  "faq": [
    {
      "question": "Faut-il un minimum de chiffre d'affaires pour justifier une assistante ?",
      "answer": "Non. La vraie question est le temps perdu. Si l'administratif prend plusieurs heures par semaine que vous pourriez facturer ou consacrer à vos clients, la délégation se rentabilise d'elle-même. Un diagnostic gratuit répond à ça précisément."
    }
  ]
};
