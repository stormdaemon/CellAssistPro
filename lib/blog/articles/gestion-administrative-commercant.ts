...
export const article: BlogArticle = {
  ...
  "description": "Le commerce demande un suivi régulier des factures, fournisseurs, échéances et documents, sans empiéter sur la vente.",
  "category": "Métiers",
  ...
  "sections": [
    ...
    {
      "heading": "Organiser l'entrée des documents",
      "list": [
    ...
    {
      "heading": "Le rythme hebdomadaire qui sauve du temps",
      "paragraphs": [
    ...
    {
      "heading": "Séparer les flux pour garder la cohérence",
      "paragraphs": [
    ...
    {
      "heading": "Trois pièges courants à esquiver",
      "list": [
