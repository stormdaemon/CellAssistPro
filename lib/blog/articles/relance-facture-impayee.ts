...
export const article: BlogArticle = {
  ...
  "description": "Une relance efficace reste calme, factuelle et régulière, sans attendre que la situation devienne tendue.",
  ...
  "sections": [
    ...
    {
      "heading": "Pourquoi chaque jour d'attente coûte",
      "paragraphs": [
    ...
    {
      "heading": "Le prestataire qui a perdu trois semaines en délai",
      "paragraphs": [
    ...
    {
      "heading": "Le système qui fonctionne : trois tentatives espacées",
      "steps": [
    ...
    {
      "heading": "Ce qu'il faut absolument éviter",
      "list": [
  ...
  "faq": [
    {
      "question": "Avant ou après la date d'échéance ?",
      "answer": "Une relance douce quelques jours après l'échéance ouvre la conversation sans culpabiliser. « Nous avons noté que la facture était due le 15, nous avons peut-être passé la date » est moins direct qu'une relance 30 jours après. Attendre un mois, c'est laisser le retard s'installer mentalement."
    },
    {
      "question": "Quand arrêter ou passer à l'escalade ?",
      "answer": "Trois tentatives espacées de deux à trois semaines chacune sont standard. Après la troisième, un appel téléphonique court clarifie les choses rapidement. S'il n'y a toujours rien, vous avez votre réponse : cette relation doit être revue ou vous explorez d'autres solutions avec le client."
    }
  ]
};
