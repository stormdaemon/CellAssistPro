...
export const article: BlogArticle = {
  ...
  "description": "Quelques indicateurs suffisent : devis en attente, factures ouvertes, trésorerie, échéances et temps administratif.",
  ...
  "sections": [
    ...
    {
      "heading": "Mettre ces indicateurs dans un format pratique",
      "paragraphs": [
    ...
    {
      "heading": "Pièges courants en suivi d'indicateurs",
      "list": [
  ...
  "faq": [
    ...
    },
    {
      ...
      "answer": "C'est leur rôle. Ils vous alertent assez tôt pour que vous agissiez. Délais d'encaissement qui s'allongent ? Relancez les clients ou durcissez les conditions. Devis en chute ? Il faut du commercial. Trésorerie serrée ? Réduisez les dépenses ou cherchez un crédit."
    }
  ]
};
