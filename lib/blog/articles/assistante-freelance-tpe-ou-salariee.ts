...
export const article: BlogArticle = {
  ...
  "description": "Une assistante freelance convient aux besoins souples, ponctuels ou progressifs ; une salariée convient à un volume stable et durable.",
  "category": "Délégation",
  ...
  "sections": [
    ...
    {
      "heading": "Signes que le besoin justifie une embauche",
      "list": [
    ...
    {
      "heading": "Le cheminement idéal pour la plupart des TPE",
      "steps": [
        "Mois 1-4 : tester une assistante freelance 10-15 heures par semaine sur un volume clair (devis, factures, relances).",
        "Mois 5 : si ça marche, discuter avec elle d'un passage au salariat ou d'une augmentation du volume freelance.",
        "Mois 6+ : si vous passez au salariat, c'est avec une personne qui connaît vos circuits. Sinon, vous savez que la flexibilité freelance vous convient et vous l'augmentez progressivement."
      ]
    },
    {
      "heading": "Les pièges à éviter absolument",
      "list": [
  ...
  "faq": [
    {
      "question": "À partir de combien d'heures vraiment une salariée devient intéressante économiquement ?",
      "answer": "À partir de 25-30 heures par semaine minimum. En dessous, le coût réel du salariat (charges comprises) dépasse souvent le coût du freelance. Et vous devez la payer même les mois creux."
    },
    {
